...
* `v1.32.2`, `latest`    [(v1.32.2/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.32.2/Dockerfile)
* `v1.31.6`,    [(v1.31.6/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.31.6/Dockerfile)
* `v1.30.10`,    [(v1.30.10/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.30.10/Dockerfile)
* `v1.29.14`,    [(v1.29.14/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.29.14/Dockerfile)
