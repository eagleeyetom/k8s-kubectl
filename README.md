...
* `v1.30.4`,    [(v1.30.4/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.30.4/Dockerfile)
* `v1.29.8`,    [(v1.29.8/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.29.8/Dockerfile)
