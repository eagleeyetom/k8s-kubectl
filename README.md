...
* `v1.30.1`, `latest`    [(v1.30.1/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.30.1/Dockerfile)
* `v1.29.5`,    [(v1.29.5/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.29.5/Dockerfile)
* `v1.28.10`,    [(v1.28.10/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.28.10/Dockerfile)
* `v1.27.14`,    [v1.27.14/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.27.14/Dockerfile)
