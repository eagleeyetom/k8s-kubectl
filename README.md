...
* `v1.32.3`, `latest`    [(v1.32.3/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.32.3/Dockerfile)
* `v1.31.7`,    [(v1.31.7/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.31.7/Dockerfile)
* `v1.30.11`,    [(v1.30.11/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.30.11/Dockerfile)
