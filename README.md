...
* `v1.30.3`, `latest`    [(v1.30.3/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.30.3/Dockerfile)
* `v1.29.6`,    [(v1.29.6/Dockerfile)](https://github.com/eagleeyetom/k8s-kubectl/blob/v1.29.6/Dockerfile)
